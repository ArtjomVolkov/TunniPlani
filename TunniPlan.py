...
#Понедельник
t1=Button(aken,text="Multimeedia",font="Arial 15",relief="groove",bg="#3399FF").grid(row=2,column=2,columnspan=2,sticky=N+S+W+E)
t1_=Button(aken,text="Programmeerimise alused",font="Arial 15",relief="groove",bg="#33FFFF").grid(row=3,column=2,columnspan=3,sticky=N+S+W+E)
t2=Button(aken,text="Programmeerimise alused",font="Arial 15",relief="groove",bg="#33FFFF").grid(row=2,column=5,columnspan=3,sticky=N+S+W+E)
t2_=Button(aken,text="Multimeedia",font="Arial 15",relief="groove",bg="#3399FF").grid(row=3,column=5,columnspan=2,sticky=N+S+W+E)
