...
t3=Button(aken,text="Rühmaju\nhataja\ntund",command=lambda:kirjeldus_aknasse("class.gif","Rühmajuhata tund"),font="Arial 15",relief="groove",bg="#33FFFF").grid(row=2,column=8,rowspan=2,sticky=N+S+W+E)
...
#Вторник
t4=Button(aken,text="Inglise keel",command=lambda:kirjeldus_aknasse("nigger.gif","Inglise keel Grupp 1"),font="Arial 15",relief="groove",bg="#FFFFCC").grid(row=4,column=2,columnspan=2,sticky=N+S+W+E)
t4_=Button(aken,text="Inglise keel",command=lambda:kirjeldus_aknasse("112.gif","Inglise keel Grupp 2"),font="Arial 15",relief="groove",bg="#FF99FF").grid(row=5,column=2,columnspan=2,sticky=N+S+W+E)
...
#Среда
t9=Button(aken,text="Multimeedia",command=lambda:kirjeldus_aknasse("mult.gif","Multimeedia"),font="Arial 15",relief="groove",bg="#3399FF").grid(row=7,column=2,columnspan=3,sticky=N+S+W+E)
t9_=Button(aken,text="Programmeerimise alused",command=lambda:kirjeldus_aknasse("11.gif","Programmeerimise alused"),font="Arial 15",relief="groove",bg="#33FFFF").grid(row=6,column=2,columnspan=3,sticky=N+S+W+E)
t10=Button(aken,text="Multimeedia",command=lambda:kirjeldus_aknasse("mult.gif","Multimeedia"),font="Arial 15",relief="groove",bg="#3399FF").grid(row=6,column=6,columnspan=3,sticky=N+S+W+E)
t11=Button(aken,text="Programmeerimise alused",command=lambda:kirjeldus_aknasse("11.gif","Programmeerimise alused"),font="Arial 15",relief="groove",bg="#33FFFF").grid(row=7,column=6,columnspan=3,sticky=N+S+W+E)
